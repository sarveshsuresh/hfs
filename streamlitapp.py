...
more_filts2=st.checkbox('More filters',key="222")
if more_filts2==True:
...
more_filts3=st.checkbox('More filters',key="333")
if more_filts3==True:
...
more_filts4=st.checkbox('More filters',key="444")
if more_filts4==True:
